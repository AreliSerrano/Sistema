...
namespace Sistema_Incidencias.Controllers
{
    public class EstadoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idUsuario,NombreCliente,Activo")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idUsuario,NombreCliente,Activo")] Estado estado)
        {
            if (ModelState.IsValid)
            {
